...
//----------------------------------------------------------------------
class Simulation :	public Parameter
{
public:
	Simulation(void);
	~Simulation(void);
	...
	//functions
	void SingleHomerange(void);
	void HomerangeEstablishment(void);
	void BreedingPeriod(void);
	void Sim_Breeding(void);
	void Sim_Density(void);
	void SimDensity_GPS(void);
};
